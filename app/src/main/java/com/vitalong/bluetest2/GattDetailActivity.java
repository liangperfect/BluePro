...
import com.vitalong.bluetest2.adapter.MessagesAdapter;
import com.vitalong.bluetest2.adapter.OptionsSelectAdapter;
import com.vitalong.bluetest2.bean.Message;
import com.vitalong.bluetest2.bean.Option;
import com.vitalong.bluetest2.views.OptionsMenuManager;
...
//                else if (state == BluetoothDevice.BOND_NONE) {}
    ...
    private void writeOption() {
        ...
        if (isHexSend) {
            ...
            Log.d("chenliang", "writeOption  isHexSend false");
