...
public class Constants {
    ...
    public static String DATA_VERIFY_NO3 = "01 03 01 02 00 02 64 37";
    public static String DATA_VERIFY_NO4 = "01 03 01 03 00 02 35 f7";
    public static String DATA_VERIFY_NO5 = "01 03 01 04 00 02 84 36";
    ...
    //选择工地号之后
    public static int SELECTOR_MODE_1 = 0;//普通模式
    public static int SELECTOR_MODE_2 = 1;//选择工地号会弹出选项
    public static int SELECTOR_MODE_3 = 2;
    ...
    public static String PRO_ROOT_PATH123 = "/storage/emulated/0/inclinometer123";
    //sd卡根目录的名称是
