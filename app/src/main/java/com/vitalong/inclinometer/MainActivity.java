...
import com.vitalong.inclinometer.fragments.BleFragment;
import com.vitalong.inclinometer.fragments.SppFragment;
                ...
                if (extras.containsKey(Constants.EXTRA_BYTE_VALUE)) {
                    if (extras.containsKey(Constants.EXTRA_BYTE_UUID_VALUE)) {
                        if (myApplication != null) {
                            ...
                            com.vitalong.inclinometer.bean.Message msg1 = new com.vitalong.inclinometer.bean.Message(com.vitalong.inclinometer.bean.Message.MESSAGE_TYPE.RECEIVE, formatMsgContent(array));
