...
//                        resolveSize(size,
//                                heightMeasureSpec)));
//        Log.d("chenliang","width->200 height->200");
//        setMeasuredDimension(1400,800);

        //获取宽高
        int width = Utils.getWindowWidth(getContext());
        int height = Utils.getWindowHeigh(getContext());
//        Log.d("chenliang", "高度是->" + width);
...
//        super.onSizeChanged(50, 50, 50, 50);
    }
